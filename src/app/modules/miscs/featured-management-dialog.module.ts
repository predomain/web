...
@NgModule({
  ...
  declarations: [FeaturedManagementComponent],
  exports: [
    FeaturedManagementComponent,
    TranslationModule,
    IconModule,
    EtherDecimalFixedModule,
    FlexLayoutModule,
  ...
  bootstrap: [],
  entryComponents: [FeaturedManagementComponent],
  schemas: [],
})
export class FeaturedManagementDialogModule {}
